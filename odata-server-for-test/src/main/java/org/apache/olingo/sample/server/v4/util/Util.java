 ...
 * under the License.
 */
package org.apache.olingo.sample.server.v4.util;
...
public class Util {
    ...
    public static boolean entityMatchesAllKeys(EdmEntityType edmEntityType, Entity entity, List<UriParameter> keyParams)
        ...
        for (final UriParameter key : keyParams) {
            ...
            try {
                valueAsString = edmPrimitiveType
                                    .valueToString(valueObject, isNullable, maxLength, precision, scale, isUnicode);
