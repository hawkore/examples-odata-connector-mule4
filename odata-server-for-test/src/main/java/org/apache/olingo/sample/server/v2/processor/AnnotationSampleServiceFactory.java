 ...
 * under the License.
 ******************************************************************************/
package org.apache.olingo.sample.server.v2.processor;
...
/**
 * The type Annotation sample service factory.
 */
public class AnnotationSampleServiceFactory extends ODataServiceFactory {
    ...
    private static class AnnotationInstances {
         ...
         * The Model package.
         */
        static final String MODEL_PACKAGE = "org.apache.olingo.sample.server.v2.model";
        /**
         * The Annotation odata service.
         */
