 ...
 * under the License.
 ******************************************************************************/
package org.apache.olingo.sample.server.v2.util;
...
public class AnnotationSampleDataGenerator {
    ...
    /**
     * The constant HTTP_HEADER_CONTENT_TYPE.
     */
    public static final String HTTP_HEADER_CONTENT_TYPE = "Content-Type";
    /**
     * The constant HTTP_HEADER_ACCEPT.
     */
    ...
    public static void main(String[] args) {
        String serviceUrl = "http://localhost:8080/ODataV2.svc";
        if (args.length == 1) {
            serviceUrl = args[0];
        }
    ...
    public void generateSampleData(String serviceUrl) {
        ...
        String manufacturerStar =
            "{\"Id\":\"1\",\"Name\":\"Star Powered Racing\",\"Founded\":\"/Date(-489024000000+0060)/\","
                + "\"Address\":{\"Street\":\"Star Street 137\",\"City\":\"Stuttgart\",\"ZipCode\":\"70173\","
                + "\"Country\":\"Germany\"}}";
        String manufacturerHorse =
            "{\"Id\":\"2\",\"Name\":\"Horse Powered Racing\",\"Founded\":\"/Date(-1266278400000+0060)/\","
                + "\"Address\":{\"Street\":\"Horse Street 1\",\"City\":\"Maranello\",\"ZipCode\":\"41053\","
                + "\"Country\":\"Italy\"}}";
        ...
        String carOneWithInlineDriverOne =
            "{\"Id\":\"1\",\"Model\":\"F1 W02\",\"Price\":\"167189.0\",\"ModelYear\":2011,\"Updated\":\"/Date"
                + "(1392989833964)/\","
                + "\"Driver\":{\"Id\":\"1\",\"Name\":\"Mic\",\"Lastname\":\"Shoemaker\",\"Nickname\":\"The Fast\","
                + "\"Birthday\":\"/Date(488671200000)/\"}}";
        String carTwoWithInlineDriverTwo =
            "{\"Id\":\"2\",\"Model\":\"F1 W04\",\"Price\":\"242189.99\",\"ModelYear\":2013,\"Updated\":\"/Date"
                + "(1392990355793)/\","
                + "\"Driver\":{\"Id\":\"2\",\"Name\":\"Nico\",\"Lastname\":\"Mulemountain\",\"Nickname\":null,"
                + "\"Birthday\":\"/Date(-31366800000)/\"}}";
        String carThreeWithInlineDriverThree =
            "{\"Id\":\"3\",\"Model\":\"FF2013\",\"Price\":\"199189.11\",\"ModelYear\":2013,\"Updated\":\"/Date"
                + "(1392990355793)/\","
                + "\"Driver\":{\"Id\":\"3\",\"Name\":\"Kimi\",\"Lastname\":\"Heikkinen\",\"Nickname\":\"Iceman\","
                + "\"Birthday\":\"/Date(308962800000)/\"}}";
        String carFour =
            "{\"Id\":\"4\",\"Model\":\"FF2014\",\"Price\":\"299189.11\",\"ModelYear\":2014,\"Updated\":\"/Date"
                + "(1392973616419)/\"}";
    ...
    private HttpStatusCodes checkStatus(HttpURLConnection connection) throws IOException {
        ...
        if (400 <= httpStatusCode.getStatusCode() && httpStatusCode.getStatusCode() <= 599) {
            ...
            throw new RuntimeException(
                "Http Connection failed with status " + httpStatusCode.getStatusCode() + " " + httpStatusCode
                                                                                                   .toString());
        }
